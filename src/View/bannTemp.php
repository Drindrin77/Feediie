...
<form action="ban.php" method="post" class="well col-md-6 col-md-offset-3">
    ...
    <div class="form-group">
        <label class="control-label" for="name">Pseudo du compte à banir : </label>
        <input type="text" class="form-control" id="ip" name="ip" required="required" />
    </div>


    <input type="submit" class="btn btn-primary" value="Bannir" name="Bannir"/>
...
//Liste des comptes precedemnent banies
