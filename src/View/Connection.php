...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body>
        ...
        <div class="container">
            ...
            <div>
                <form method="post" action="/verifyConnection" enctype="multipart/form-data">
                    <div class="form-group">
                        <!-- Connection-->
                        <label for="emailInput">Email:</label>
                        <input type="email" id="email" required size="50" class="form-control" placeholder="email@mail.com" value=<?php $mail?>>
                    </div>
                    <div class="form-group">
                        <input type="password" id="password">
                    </div>
                    <input type="button" id="btnSubmit" value="Connexion" class="btn btn-primary"/>
                </form>
                <div class="row-md-2">
                    <!-- Inscrivez-vous -->
                    <p> 
