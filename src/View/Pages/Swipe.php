                ...
                <div class="col">
                    <div id="blockParameters container" class="overflow-auto">
                        ...
                        <div>
                            ...
                            <div id="showMore1" class="showMoreBtn"><i style='font-size:18px;color:white' class='fas'>&#xf103;</i>
                            </div>
                            ...
                            <div class="titleParameter"><h5>Tes envies</h5></div>
                            <div id="boxSelectModified2" class="boxSelectModified">
                                <?php foreach ($diets as $diet): ?>
                                    <div class="custom-control custom-switch">
                                        ...
                                        >
                                        <label class="custom-control-label"
                                               for="<?= $diet['iddiet'] ?>"><?= $diet['name'] ?></label>
                                    </div>
                                <? endforeach; ?>
                            </div>
                            <div id="showMore3" class="showMoreBtn"><i class='fas'>&#xf103;</i></div>
                            ...
                            <div id="showMore2" class="showMoreBtn"><i class='fas'>&#xf103;</i>
                            </div>
                        </div>
                    </div>
