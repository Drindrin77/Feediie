...
INSERT INTO FeediieUser VALUES
    (default, 'jzpeerz58aze',null ,'Leanna', 'Ji', '1999-04-11','leiina77410@gmail.com','$2y$10$DMjYUV76Y7GYJlC45pTOKOG8UjFw.tnEfm1WgIqlLzoiImYEKf4ra', 'balbalbal', 
        default, default, default, default, 'token', default, 1, default, 'Femme');


INSERT INTO FeediieUser VALUES
    (default, 'arjaze98e58a5ab','Valentin', 'ELOY', '1998-02-14','valentinbgdu54@gmail.com','$2y$10$DMjYUV76Y7GYJlC45pTOKOG8UjFw.tnEfm1WgIqlLzoiImYEKf4ra', 'Je suis valentin je viens de Nancy',
        default, default, default, default, 'token2', default, 1, default, 'Homme');

INSERT INTO Photo VALUES
    (default, '/Images/UserUpload/jzpeerz58aze/1.jpg', true, 1);

INSERT INTO Photo VALUES
    (default, '/Images/UserUpload/arjaze98e58a5ab/1.jpg', 1, 1), (default, '/Images/UserUpload/arjaze98e58a5ab/2.jpg',2,1);
